    ...
    <>
      ...
      <div className="w-11/12 max-w-[1390px] flex flex-col mx-auto mt-10 fadeIn">
        <div className="w-full flex flex-row md:flex-col tracking-tighter justify-between items-stretch">
          <div className="flex flex-col items-center justify-center w-1/2 md:w-full bg-primary rounded-3xl p-10 md:p-2 md:py-5 mr-5 md:mr-0 h-full">
          ...
          <div className="w-1/2 md:w-full rounded-3xl ml-5 md:ml-0 mt-5 fadeIn flex flex-col justify-center items-center h-full">
