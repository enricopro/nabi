  ...
  return (
    <>
      ...
      <div className="w-11/12 max-w-[1390px] flex flex-col mx-auto mt-20 md:mt-10 fadeIn">
        <div className="w-full flex flex-row md:flex-col-reverse tracking-tighter justify-between items-stretch">
          <div className="flex flex-col items-center justify-center w-1/2 md:w-full bg-primary rounded-3xl p-10 md:p-8 mr-5 md:mr-0 md:mt-4 h-full">
          ...
          <div className="w-1/2 md:w-full rounded-3xl ml-5 md:ml-0 mt-5 md:mt-0 fadeIn flex flex-col justify-center items-center h-full">
      ...
      <div className="w-11/12 max-w-[1390px] flex flex-col mx-auto mt-10 md:mt-4 fadeIn">
        <div className="w-full flex flex-row md:flex-col tracking-tighter justify-between ld:items-center">
          <div className="w-1/2 md:w-full md:h-[490px] rounded-3xl mr-5 md:mr-0 fadeIn bg-cover bg-right ld:h-[590px] md:mb-4" style={{backgroundImage: `url(${cctv})`}}>
          </div>
          <div className="flex flex-col items-center justify-center w-1/2 md:w-full bg-primary rounded-3xl p-10 md:p-8 ml-5 md:ml-0 md:mb-0">
      ...
      <div className="w-11/12 max-w-[1390px] flex flex-col mx-auto mt-10 md:mt-0 fadeIn">
        <div className="w-full flex flex-row md:flex-col-reverse tracking-tighter min-h-[490px] justify-between ld:items-center">
          <div className="flex flex-col items-center justify-center w-1/2 md:w-full bg-primary rounded-3xl p-10 md:p-8 md:mt-0 mr-5 md:mr-0 md:mb-4">
          ...
          <div className="w-1/2 md:w-full md:h-[490px] rounded-3xl ml-5 md:ml-0 fadeIn bg-cover bg-right md:mt-4 ld:h-[590px] md:mb-4" style={{backgroundImage: `url(${locker})`}}>
          </div>
        </div>
      </div>
      <div className="w-11/12 max-w-[1390px] flex flex-col mx-auto my-10 md:mt-4 md:mb-0 fadeIn">
        <div className="w-full flex flex-row md:flex-col tracking-tighter min-h-[490px] justify-between ld:items-center">
          <div className="w-1/2 md:w-full md:h-[390px] rounded-3xl mr-5 md:mr-0 md:mb-4 md:mt-0 fadeIn bg-cover bg-center md:bg-contain md:bg-no-repeat ld:h-[590px]" style={{backgroundImage: `url(${btcbutterfly})`}}>
          </div>
          <div className="flex flex-col items-center justify-center w-1/2 md:w-full bg-primary rounded-3xl p-10 md:p-8 ml-5 md:ml-0 md:mb-4">
            ...
            <a href="https://bit.ly/3AReQQT" className="p-5 py-3 bg-[#5865F2] ml-5 md:ml-0 mt-5 rounded-3xl hover:bg-blue-500 text-white text-center font-bold transition-all">Let’s talk on Discord</a>
          </div>
        </div>
      </div>
